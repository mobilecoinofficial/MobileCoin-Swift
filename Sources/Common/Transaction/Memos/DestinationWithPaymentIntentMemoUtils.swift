        ...
        let bytes: Data16 = memoData.asMcBuffer { memoDataPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    ...
                    // mc_memo_destination_with_payment_intent_memo_get_address_hash are
        ...
        destinationPublicAddress.withUnsafeCStructPointer { destinationPublicAddressPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    // Safety: This condition indicates a programming error and can only
                    // happen if arguments to
                    // mc_memo_destination_with_payment_intent_memo_create are
                    // supplied incorrectly.
                    logger.warning("error: \(redacting: error)")
                    return nil
                default:
        ...
        memoData.asMcBuffer { memoDataPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    // Safety: This condition indicates a programming error and can only
                    // happen if arguments to
                    // mc_memo_destination_with_payment_intent_memo_get_fee are
                    // supplied incorrectly.
                    logger.warning("error: \(redacting: error)")
                    return nil
                default:
        ...
        memoData.asMcBuffer { memoDataPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    // Safety: This condition indicates a programming error and can only
                    // happen if arguments to
                    // mc_memo_destination_with_payment_intent_memo_get_total_outlay are
                    // supplied incorrectly.
                    logger.warning("error: \(redacting: error)")
                    return nil
                default:
        ...
        memoData.asMcBuffer { memoDataPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    ...
                    // if arguments to
                    // mc_memo_destination_with_payment_intent_memo_get_number_of_recipients are
                    // supplied incorrectly.
                    logger.warning("error: \(redacting: error)")
                    return nil
                default:
        ...
        memoData.asMcBuffer { memoDataPtr in
            ...
            case .failure(let error):
                ...
                case .invalidInput:
                    // Safety: This condition indicates a programming error and can only
                    // happen if arguments to
                    // mc_memo_destination_with_payment_intent_memo_get_payment_intent_id are
                    // supplied incorrectly.
                    logger.warning("error: \(redacting: error)")
                    return nil
                default:
