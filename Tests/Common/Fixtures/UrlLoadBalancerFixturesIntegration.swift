...
struct UrlLoadBalancerFixturesIntegration {
...
protocol ServiceFixtureIntegration {
...
extension UrlLoadBalancerFixturesIntegration {

    struct Blockchain: ServiceFixtureIntegration {
        ...
        init(with transportProtocol: TransportProtocol, useValidUrls: Bool) throws {
            ...
            self.seqLoadBalancer = try {
                useValidUrls
                ? try UrlLoadBalancerFixturesIntegration().validUrlsConsensusUrlBalancer
                : try UrlLoadBalancerFixturesIntegration().initialInvalidConsensusUrlBalancer
            }()
    ...
    struct Consensus: ServiceFixtureIntegration {
    ...
    struct FogBlock: ServiceFixtureIntegration {
        ...
        init(with transportProtocol: TransportProtocol, useValidUrls: Bool) throws {
            ...
            self.seqLoadBalancer = try {
                useValidUrls
                ? try UrlLoadBalancerFixturesIntegration().validUrlsFogUrlBalancer
                : try UrlLoadBalancerFixturesIntegration().initialInvalidUrlFogUrlBalancer
            }()
    ...
    struct FogKeyImage: ServiceFixtureIntegration {
    ...
    struct FogMerkleProof: ServiceFixtureIntegration {
    ...
    struct FogUntrustedTxOut: ServiceFixtureIntegration {
    ...
    struct FogView: ServiceFixtureIntegration {
